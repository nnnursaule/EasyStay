...
urlpatterns = [
    ...
    path('complaint/apartment/<int:apartment_id>/', views.submit_complaint, name='submit_complaint'),
    path('complaint/complex/<int:rc_id>/', views.submit_complaint_to_rc, name='submit_complaint_complex'),
